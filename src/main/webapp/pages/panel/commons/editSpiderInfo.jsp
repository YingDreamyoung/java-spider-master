...
<head>
    ...
    <script>
        ...
        function formToJson(form) {
            ...
            result['needAuthor'] = $("#needAuthor").prop('checked');
        ...
        <div class="col-md-12">
            <form id="spiderInfoForm" action="${pageContext.request.contextPath}/commons/spider/testSpiderInfo">
                ...
                <div id="advancedSetting" style="display: none;">
                    ...
                    <div class="form-group">
                        <label for="contentReg">authorReg</label>
                        <input type="text" class="form-control" id="authorReg" name="authorReg" placeholder="作者正则表达式"
                               value="${spiderInfo.contentReg}">
                    </div>
                    <div class="form-group">
                        <label for="authorXPath">authorXPath</label>
                        <input type="text" class="form-control" id="authorXPath" name="authorXPath"
                               placeholder="作者Xpath"
                               value="${spiderInfo.authorXPath}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="detailUrlXPath">detailUrlXPath</label>
                        <input type="text" class="form-control" id="detailUrlXPath" name="detailUrlXPath" placeholder="获取详情页Url xpath 提高命中率"
                               value="${spiderInfo.detailUrlXPath}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="checkbox">
                            <label>
                                <c:if test="${spiderInfo.needAuthor}">
                                    <input type="checkbox" name="needAuthor" id="needAuthor"
                                           checked="checked">
                                </c:if>
                                <c:if test="${!spiderInfo.needAuthor}">
                                    <input type="checkbox" name="needAuthor" id="needAuthor">
